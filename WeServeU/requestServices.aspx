...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="createAcctContainer">
        <div class="createAcctMain">
            ...
            <asp:CompareValidator ID="passwordCompareValidator" runat="server" ErrorMessage="*" ControlToCompare="txtPassword" ControlToValidate="txtPasswordVerified" ForeColor="Red"></asp:CompareValidator>
        </div>
        <br />
