...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="cstLoginPnl">
        ...
        <asp:Label ID="Label1" runat="server" Text="Username:" CssClass="lblLogin"></asp:Label><asp:TextBox ID="txtCstUser" runat="server" CssClass="txtLogin" MaxLength="25" ValidationGroup="cstLogintxt"></asp:TextBox>
        ...
        <asp:Label ID="Label2" runat="server" Text="Password:" CssClass="lblLogin"></asp:Label><asp:TextBox ID="txtCstPass" runat="server" TextMode="Password" CssClass="txtLogin" ValidationGroup="cstLogintxt"></asp:TextBox>
    ...
    <div id="empLoginPnl">
        ...
        <asp:Label ID="Label3" runat="server" Text="Username:" CssClass="lblLogin"></asp:Label><asp:TextBox ID="txtEmpUser" runat="server" CssClass="txtLogin" MaxLength="25" ValidationGroup="empLogintxt"></asp:TextBox>
        ...
        <asp:Label ID="Label4" runat="server" Text="Password:" CssClass="lblLogin"></asp:Label><asp:TextBox ID="txtEmpPass" runat="server" TextMode="Password" CssClass="txtLogin" ValidationGroup="empLogintxt"></asp:TextBox>
        ...
        <br />
        <asp:Button ID="btnEmpLogin" runat="server" Text="Login" CssClass="btnLogin" CausesValidation="true" ValidationGroup="empLogintxt" OnClick="btnEmpLogin_Click"/><br />
