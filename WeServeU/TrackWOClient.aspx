<%@ Page Title="WeServeU -Client Work Order-" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TrackWOClient.aspx.cs" Inherits="TrackWOClient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" CssClass="updateTable" Height="50px" Width="100%" AutoGenerateRows="False" DataKeyNames="WorkOrderID" DataSourceID="WOClientDataSource">
    ...
    <asp:SqlDataSource ID="WOClientDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:UpdateWODataConnection %>" SelectCommand="SELECT * FROM [WorkOrder] WHERE ([WorkOrderID] = @WorkOrderID) ORDER BY [WorkOrderID]">
        <SelectParameters>
