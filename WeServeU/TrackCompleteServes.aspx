...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DetailsView ID="completeServes" CssClass="completeServesDetails" runat="server" Height="50px" AutoGenerateRows="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataSourceID="CompletedServesSqlDataSource" ForeColor="Black" GridLines="Vertical" DataKeyNames="WorkOrderID">
    ...
    <asp:SqlDataSource ID="CompletedServesSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:UpdateWODataConnection %>" SelectCommand="SELECT * FROM [WorkOrder]"></asp:SqlDataSource>
</asp:Content>
