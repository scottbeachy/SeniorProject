...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DetailsView ID="completeServes" CssClass="updateTable" runat="server" Height="50px" AutoGenerateRows="False"  DataSourceID="CompletedServesSqlDataSource" DataKeyNames="WorkOrderID">
    ...
    <asp:SqlDataSource ID="CompletedServesSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:UpdateWODataConnection %>" SelectCommand="SELECT * FROM [WorkOrder] WHERE ([WorkOrderID] = @WorkOrderID) ORDER BY [WorkOrderID]">
        <SelectParameters>
